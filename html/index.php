...
<html lang="ru">
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <form class="cast_form" method="POST" action="/index.php">
                        ...
                        <div class="row form__reg"><button type="submit" class="btn_red btn__reg" name="submit">Продолжить</button></div>
                        <div class="row form__reg"><a href="/registration.php">Зарегистрируйтесь</a></div>
                    </form>
                </div>
            </div>
        </div>
